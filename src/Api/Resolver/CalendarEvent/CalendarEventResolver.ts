...
export default class CalendarEventResolver {
    ...
    async createCalendarEvent(
	  ...
	  return await (await this.useCaseFactory.create(CreateCalendarEventUseCase))
    ...
    async updateCalendarEvent(
	  ...
	  return await (await this.useCaseFactory.create(UpdateCalendarEventUseCase))
    ...
    async deleteCalendarEvent(
	  ...
	  return await (await this.useCaseFactory.create(DeleteCalendarEventUseCase))
    ...
    async getAllCalendarEvents(
	  ...
	  return await (await this.useCaseFactory.create(GetAllCalendarEventsUseCase))
    ...
    async getCalendarEvent(
	  ...
	  return await (await this.useCaseFactory.create(GetOneCalendarEventUseCase))
		  .handle(context, id) as CalendarEvent;
    }
    ...
    async getCalendarEventsByUserId(
	  ...
	  return await (await this.useCaseFactory.create(GetCalendarEventsByUserIdUseCase))
    ...
    async markNotificationAsSent(
	  ...
	  return await (await this.useCaseFactory.create(MarkNotificationAsSentUseCase))
		  .handle(context, id) as CalendarEvent;
    }
}
