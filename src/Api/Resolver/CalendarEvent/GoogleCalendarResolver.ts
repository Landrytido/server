...
import SyncCalendarEventsFromGoogleUseCase from "../../UseCase/CalendarEvent/SyncCalendarEventsFromGoogle/SyncCalendarEventsFromGoogleUseCase";
...
export class GoogleCalendarResolver {
  ...
  @Mutation(() => Boolean, {
    description: "Synchronize Google Calendar events",
  })
  async syncGoogleCalendar(
    ...
    try {
      await (
        await this.useCaseFactory.create(SyncCalendarEventsFromGoogleUseCase)
