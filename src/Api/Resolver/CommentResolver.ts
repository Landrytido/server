...
export default class CommentResolver {
  ...
  async createComment(
    ...
    try {
      const createCommentUseCase =
        await this.serviceFactory.create(CreateCommentUseCase);
  ...
  async deleteComment(
    ...
    try {
      const deleteCommentUseCase =
        await this.serviceFactory.create(DeleteCommentUseCase);
  ...
  async updateComment(
    ...
    try {
      const updateCommentUseCase =
        await this.serviceFactory.create(UpdateCommentUseCase);
  ...
  async findCommentsByNoteId(
    ...
    try {
      const findCommentsByNoteIdUseCase = await this.serviceFactory.create(
        FindCommentsByNoteIdUseCase,
      );
      const comments = await findCommentsByNoteIdUseCase.handle(
        context,
        noteId,
      );
