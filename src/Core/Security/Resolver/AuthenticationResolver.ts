...
export default class AuthenticationResolver {
  ...
  async validateToken(@Args("dto") dto: TokenValidationDto): Promise<boolean> {
    const validateTokenUseCase =
      await this.useCaseFactory.create(ValidateToken);
  ...
  async loginWithGoogle(
    ...
    const loginWithGoogleUseCase =
      await this.useCaseFactory.create(LoginWithGoogle);
  ...
  async loginWithFacebook(
    ...
    const loginWithFacebookUseCase =
      await this.useCaseFactory.create(LoginWithFacebook);
  ...
  async loginWithGithub(@Args("dto") dto: LoginWithGithubDto): Promise<string> {
    const loginWithGithubUseCase =
      await this.useCaseFactory.create(LoginWithGithub);
